...
async def help_cmd(message: Message):
    help_text = (
        ...
        "🔹 /menu — главное меню\n"
        "🔹 /profile — посмотреть профиль и автомобили\n"
        "🔹 /settings — настройки бота\n"
        "🔹 /help — показать это сообщение\n\n"
        "🚗 *Управление автомобилями:*\n"
        "🔸 Добавить автомобиль — `Добавить Авто`\n"
        "🔸 Удалить автомобиль — `Удалить Авто`\n"
        "🔸 Создать заметку о расходах — `Создать заметку о расходах`\n\n"
        "📅 *Напоминания:*\n"
        "🔔 Создать напоминание — `Создать напоминание`\n"
        "❌ Удалить напоминание — `Удалить напоминание`\n\n"
        "🛍 *Покупки и избранное:*\n"
        "✨ Добавить товар в избранное — `Добавить товар в избранное`\n"
        "📜 Мои товары — `Мои товары`\n\n"
        "❓ Если у вас возникли вопросы, напишите нам! 😊- /bug"
    )
